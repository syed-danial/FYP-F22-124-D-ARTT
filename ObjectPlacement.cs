...
public class ObjectPlacement : MonoBehaviour
{
    ...
    {
        // if(arOrigin != null && placementPose != null)
        // { 
                //bot.statue = true;
                //Debug.Log("aa"+bot.statue);
        if(Camera.current.ViewportToScreenPoint(new Vector3(0.5f, 0.5f)) != null) 
        {    
        //Debug.Log(Camera.current.ViewportToScreenPoint(new Vector3(0.5f, 0.5f)));
